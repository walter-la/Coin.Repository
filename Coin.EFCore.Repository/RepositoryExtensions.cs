...
namespace Coin.EFCore.Repository
{
	public static class RepositoryExtensions
	{
		...
		public static void BulkInsertSave<TEntity>(this DbContext db, IList<TEntity> entities) where TEntity : class
		{
			db.BulkInsert(entities);
		}

		public static Task BulkInsertSaveAsync<TEntity>(this DbContext db, IList<TEntity> entities) where TEntity : class
		{
			return db.BulkInsertAsync(entities);
		}

		public static void BulkUpdateSave<TEntity>(this DbContext db, IList<TEntity> entities) where TEntity : class
		{
			db.BulkUpdate(entities);
		}

		public static Task BulkUpdateSaveAsync<TEntity>(this DbContext db, IList<TEntity> entities) where TEntity : class
		{
			return db.BulkInsertOrUpdateAsync(entities);
		}

		public static void BulkInsertOrUpdateSave<TEntity>(this DbContext db, IList<TEntity> entities) where TEntity : class
		{
			db.BulkInsertOrUpdate(entities);
		}

		public static Task BulkInsertOrUpdateSaveAsync<TEntity>(this DbContext db, IList<TEntity> entities) where TEntity : class
		{
			return db.BulkInsertOrUpdateAsync(entities);
		}
	}
